                    ...
                    try {
                        ...
                        if ($payment && $payment['status'] === 'captured') {
                            ...
                            if ($orderData) {
                                ...
                                // Get booking details and send ticket
                                $stmt = $conn->prepare("
                            ...
                            $error = "Payment not found or not captured. Status: " . ($payment['status'] ?? 'Unknown');
                        }
                    } catch (Exception $e) {
...
$stmt = $conn->prepare("
    SELECT po.*, b.booking_id, b.name, b.contact_email, b.contact_mobile, b.destination, b.fare
...
function generateTicketHTML($booking, $paymentId) {
    ...
    <head>
        ...
        <style>
            ...
            .admin-notice { background: #d1ecf1; padding: 15px; border-radius: 8px; margin: 15px 0; border-left: 4px solid #17a2b8; }
        </style>
    </head>
    <body>
        <div class="ticket-container">
            ...
            <div class="ticket-body">
                <div class="payment-info">
                    <strong>✅ Payment Confirmed (Admin Verified)</strong><br>
...
function sendTicketEmail($booking, $pdfData, $paymentId) {
    try {
        ...
        // Email subject
        $subject = "🎫 Your Travel Ticket (Admin Verified) - Booking ID: " . $booking['booking_id'];
        ...
        <head>
            <style>
                ...
                .admin-notice { background: #d1ecf1; color: #0c5460; padding: 15px; border-radius: 8px; margin: 15px 0; }
        ...
        <body>
            ...
            <div class='content'>
                ...
                <div class='admin-notice'>
                    <h3>👨‍💼 Admin Verification Notice</h3>
        ...
        if ($mailSent) {
            error_log("Admin ticket email sent successfully to: $contactEmail for booking: " . $booking['booking_id']);
            return true;
        } else {
            error_log("Failed to send admin ticket email to: $contactEmail for booking: " . $booking['booking_id']);
            return false;
        }
...
<head>
    ...
    <title>Admin - Manual Payment Verification</title>
...
<body>
    <div class="container-fluid">
                ...
                <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
                    <div class="container-fluid">
                        ...
                        <div class="navbar-nav ms-auto">
                            ...
                            <a class="nav-link active" href="admin_manual_payment_verification.php">Payment Verification</a>
        ...
        <div class="container mt-4">
            <h1 class="mb-4">
                <i class="fas fa-credit-card"></i> Manual Payment Verification
            </h1>
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h5><i class="fas fa-check-circle"></i> Verify Payment</h5>
                        </div>
                        <div class="card-body">
                            <form method="POST">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-sm btn-info" onclick="fillPaymentForm('<?php echo $payment['razorpay_order_id']; ?>')">
                                            <i class="fas fa-edit"></i> Verify
                                        </button>
                                    </td>
                                </tr>
                                <?php endwhile; ?>
    ...
    <script>
        function fillPaymentForm(orderId) {
